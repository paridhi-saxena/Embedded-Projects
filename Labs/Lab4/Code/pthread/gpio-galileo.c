...
int main(void) {
		...
		printf("msg after\n");
	       ...
	       while(readGPIO(fileHandleGPIO_S) == 0) {
               int bit3 = readGPIO(fileHandleGPIO_4);
               int bit2 = readGPIO(fileHandleGPIO_5);
               int bit1 = readGPIO(fileHandleGPIO_6);
               int bit0 = readGPIO(fileHandleGPIO_7);
	       printf("%d %d %d %d\n", bit3, bit2, bit1, bit0);
               int res = (((((bit3 << 1) + bit2) << 1) + bit1) << 1) + bit0;
               printf("%d %d %d %d \n", bit3, bit2, bit1, bit0);
               if(res == 0xE) {
                    printf("Got Ack!!!!!");
		    break;
